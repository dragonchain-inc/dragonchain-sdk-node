...
export class CredentialService {
   ...
   */
  public static createCredentials = async (dragonchainId: string, authKey: string = '', authKeyId: string = '', hmacAlgo: HmacAlgorithm = 'SHA256', injected: any = { getDragonchainCredentials }) => {
