...
export declare class DragonchainClient {
    ...
    createTransactionType: (options: {
         ...
         */
        customIndexes?: TransactionTypeCustomIndexes[] | undefined;
