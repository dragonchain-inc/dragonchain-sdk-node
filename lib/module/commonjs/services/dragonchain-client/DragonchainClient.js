...
class DragonchainClient {
    ...
    constructor(endpoint, credentials, verify, injected = {}) {
         ...
         */
        this.createApiKey = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.post('/api-key', {});
        });
        /**
         * List HMAC API key IDs and their associated metadata
         */
        this.listApiKeys = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.get('/api-key');
        });
        /**
         * Get metadata about an existing HMAC API key
         */
        this.getApiKey = (options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!options.keyId)
                throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'Parameter `keyId` is required');
            return yield this.get(`/api-key/${options.keyId}`);
        });
        /**
         * Delete an existing HMAC API key
         */
        this.deleteApiKey = (options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!options.keyId)
                throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'Parameter `keyId` is required');
            return yield this.delete(`/api-key/${options.keyId}`);
        });
        /**
        ...
        this.getSmartContract = (options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'At least one of `smartContractId` or `transactionType` must be supplied');
        });
        /**
        ...
        this.updateTransactionType = (options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!options.transactionType)
                throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'Parameter `transactionType` is required');
            if (!options.customIndexes)
                throw new FailureByDesign_1.FailureByDesign('PARAM_ERROR', 'Parameter `customIndexes` is required');
            const body = {
                version: '1',
