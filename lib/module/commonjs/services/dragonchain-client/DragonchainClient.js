...
class DragonchainClient {
    ...
    constructor(dragonchainId = '', verify = true, injected = {}) {
        ...
        this.test = () => tslib_1.__awaiter(this, void 0, void 0, function* () { return yield this.put('/contract'); });
        /**
         ...
         */
        this.getSmartContract = (contractName) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.get(`/contract/${contractName}`);
        });
        /**
         ...
         */
        this.deleteSmartContract = (txnType) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.delete(`/contract/${txnType}`);
        });
        /**
