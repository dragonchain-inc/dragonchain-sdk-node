...
describe('DragonchainClient', () => {
    ...
    describe('.isValidRuntime', () => {
        it('returns true when valid', () => {
            expect(DragonchainClient_1.DragonchainClient.isValidRuntime('nodejs6.10')).to.equal(true);
            expect(DragonchainClient_1.DragonchainClient.isValidRuntime('nodejs8.10')).to.equal(true);
            expect(DragonchainClient_1.DragonchainClient.isValidRuntime('java8')).to.equal(true);
            expect(DragonchainClient_1.DragonchainClient.isValidRuntime('python2.7')).to.equal(true);
            expect(DragonchainClient_1.DragonchainClient.isValidRuntime('python3.6')).to.equal(true);
            expect(DragonchainClient_1.DragonchainClient.isValidRuntime('dotnetcore1.0')).to.equal(true);
            expect(DragonchainClient_1.DragonchainClient.isValidRuntime('dotnetcore2.0')).to.equal(true);
            expect(DragonchainClient_1.DragonchainClient.isValidRuntime('dotnetcore2.1')).to.equal(true);
            expect(DragonchainClient_1.DragonchainClient.isValidRuntime('go1.x')).to.equal(true);
        });
        it('returns false when invalid', () => {
            expect(DragonchainClient_1.DragonchainClient.isValidRuntime('derp')).to.equal(false);
        });
    });
    ...
    describe('PUT', () => {
        ...
        describe('.updateMatchmakingConfig', () => {
            it('calls #fetch() with correct params', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield client.updateMatchmakingConfig(askingPrice);
                const obj = Object.assign({}, expectedFetchOptions, { body: JSON.stringify(fakeBodyResponse) });
                sinon_1.assert.calledWith(fetch, `https://fakeDragonchainId.api.dragonchain.com/update-matchmaking-data`, obj);
            }));
        });
        describe('.updateDragonnetConfig', () => {
            it('calls #fetch() with correct params', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield client.updateDragonnetConfig({ l2: maximumPrice });
                const obj = Object.assign({}, expectedFetchOptions, { body: JSON.stringify(fakeBodyResponse) });
                sinon_1.assert.calledWith(fetch, `https://fakeDragonchainId.api.dragonchain.com/update-matchmaking-data`, obj);
            }));
        });
