...
describe('DragonchainClient', () => {
    ...
    describe('GET', () => {
        ...
        describe('.getApiKey', () => {
            it('calls #fetch() with correct params', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield client.getApiKey({ keyId: 'MyKeyID' });
                sinon_1.assert.calledWith(fetch, 'fakeUrl/api-key/MyKeyID', expectedFetchOptions);
            }));
        });
        describe('.listApiKeys', () => {
            it('calls #fetch() with correct params', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield client.listApiKeys();
                sinon_1.assert.calledWith(fetch, 'fakeUrl/api-key', expectedFetchOptions);
            }));
        });
    ...
    describe('DELETE', () => {
        ...
        it('.deleteApiKey', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield client.deleteApiKey({ keyId: 'MyKeyID' });
            sinon_1.assert.calledWith(fetch, 'fakeUrl/api-key/MyKeyID', expectedFetchOptions);
        }));
    });
    describe('POST', () => {
        ...
        describe('.createApiKey', () => {
            it('calls #fetch() with correct params', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield client.createApiKey();
                const expectedBody = {};
                sinon_1.assert.calledWith(fetch, 'fakeUrl/api-key', Object.assign({}, expectedFetchOptions, { body: JSON.stringify(expectedBody) }));
            }));
        });
