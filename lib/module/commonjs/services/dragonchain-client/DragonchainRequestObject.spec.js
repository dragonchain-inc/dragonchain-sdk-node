...
const DragonchainRequestObject_1 = require("./DragonchainRequestObject");
...
describe('DragonchainRequestObject', () => {
    describe('#constructor', () => {
        it('assigns default instance vars', () => {
            const fetchOptions = { method: 'PUT', body: 'hi!', headers: { 'Content-Type': 'application/json' } };
            const dro = new DragonchainRequestObject_1.DragonchainRequestObject('/chains/contract', 'myDcid', fetchOptions);
