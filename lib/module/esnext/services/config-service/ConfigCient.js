 ...
 */
const getConfigFilePath = (injected = { platform, homedir }) => {
 ...
 */
const getIdFromFile = async (injected = { readFileAsync }) => {
    let config = {};
    try {
 ...
 */
const getEndpointFromFile = async (dragonchainId, injected = { readFileAsync }) => {
    let config = {};
    try {
        config = ini.parse(await injected.readFileAsync(getConfigFilePath(), 'utf-8'));
    }
 ...
 */
const getCredsFromFile = async (dragonchainId, injected = { readFileAsync }) => {
    let config = {};
    try {
        config = ini.parse(await injected.readFileAsync(getConfigFilePath(), 'utf-8'));
    }
 ...
 */
const getEndpointFromRemote = async (dragonchainId, injected = { fetch }) => {
    try {
 ...
 */
const getCredsAsSmartContract = async (injected = { readFileAsync }) => {
    let authKeyId = '';
    let authKey = '';
 ...
 */
const getDragonchainId = async (injected = { getIdFromEnvVars, getIdFromFile }) => {
 ...
 * @throws {FailureByDesign<NOT_FOUND>}
 */
const getDragonchainEndpoint = async (dragonchainId, injected = { getEndpointFromEnvVars, getEndpointFromFile, getEndpointFromRemote }) => {
 ...
 * @throws {FailureByDesign<NOT_FOUND>}
 */
const getDragonchainCredentials = async (dragonchainId, injected = { getCredsFromEnvVars, getCredsFromFile, getCredsAsSmartContract }) => {
