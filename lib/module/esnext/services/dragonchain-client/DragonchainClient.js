...
export class DragonchainClient {
    ...
    constructor(dragonchainId = '', verify = true, injected = {}) {
         ...
         */
        this.getSmartContract = async (contractName) => {
            return await this.get(`/contract/${contractName}`);
        };
        /**
         ...
         */
        this.updateSmartContract = async (txnType, image, cmd, executionOrder, desiredState, args, env, secrets, seconds, cron, auth) => {
            const body = {
                version: '3',
            ...
            if (auth)
                body['auth'] = auth;
            return await this.put(`/contract/${txnType}`, body);
        };
        /**
         ...
         */
        this.deleteSmartContract = async (txnType) => {
            return await this.delete(`/contract/${txnType}`);
        };
        /**
 ...
 */
DragonchainClient.isValidRuntime = (runtime) => validRuntimes.includes(runtime);
/**
